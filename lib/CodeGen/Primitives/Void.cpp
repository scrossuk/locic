...
namespace locic {
	...
	namespace CodeGen {
		...
		llvm::Value* genVoidPrimitiveMethodCall(Function& functionGenerator, const SEM::Type*, const String& methodName, const SEM::Type* const /*functionType*/, PendingResultArray /*args*/) {
