...
namespace locic {
	...
	namespace CodeGen {
		...
		void
		SEMCodeEmitter::emitUserFunctionCode(const AST::Function& function) {
		...
		void
		SEMCodeEmitter::emitParameterAllocas(const AST::Function& function) {
			auto& module = functionGenerator_.module();
		...
		void
		SEMCodeEmitter::emitScopeFunctionCode(const AST::Function& function) {
