...
namespace locic {
	...
	namespace CodeGen {
		...
		void
		SEMCodeEmitter::emitUserFunctionCode(const AST::FunctionDecl& function) {
		...
		void
		SEMCodeEmitter::emitParameterAllocas(const AST::FunctionDecl& function) {
			auto& module = functionGenerator_.module();
		...
		void
		SEMCodeEmitter::emitScopeFunctionCode(const AST::FunctionDecl& function) {
