...
namespace locic {
	...
	namespace CodeGen {
		...
		public:
			...
			llvm::Value* emitValue(const SEM::Value& value,
			...
			llvm::Value* emitConstant(const SEM::Value& value) {
			...
			llvm::Value* emitAlias(const SEM::Value& value, llvm::Value* const hintResultValue) {
			...
			llvm::Value* emitLocalVar(const SEM::Value& value) {
				const auto& var = value.localVar();
				return irEmitter_.function().getLocalVarMap().get(&var);
			}
			
			llvm::Value* emitReinterpretCast(const SEM::Value& value, llvm::Value* const hintResultValue) {
			...
			llvm::Value* emitDerefReference(const SEM::Value& value) {
			...
			llvm::Value* emitUnionDataOffset(const SEM::Value& value) {
			...
			llvm::Value* emitMemberOffset(const SEM::Value& value) {
				// Offset of union datatype data is equivalent to its
				// alignment size.
				return genMemberOffset(irEmitter_.function(), value.memberOffsetTypeInstance()->selfType(), value.memberOffsetMemberIndex());
			}
			
			llvm::Value* emitTernary(const SEM::Value& value, llvm::Value* const hintResultValue) {
			...
			llvm::Value* emitCast(const SEM::Value& value, llvm::Value* const hintResultValue) {
			...
			llvm::Value* emitPolyCast(const SEM::Value& value) {
			...
			llvm::Value* emitLval(const SEM::Value& value, llvm::Value* const hintResultValue) {
				return emitValue(value.makeLvalOperand(), hintResultValue);
			}
			
			llvm::Value* emitNoLval(const SEM::Value& value, llvm::Value* const hintResultValue) {
				return emitValue(value.makeNoLvalOperand(), hintResultValue);
			}
			
			llvm::Value* emitRef(const SEM::Value& value, llvm::Value* const hintResultValue) {
				return emitValue(value.makeRefOperand(), hintResultValue);
			}
			
			llvm::Value* emitNoRef(const SEM::Value& value, llvm::Value* const hintResultValue) {
				return emitValue(value.makeNoRefOperand(), hintResultValue);
			}
			
			llvm::Value* emitStaticRef(const SEM::Value& value, llvm::Value* const hintResultValue) {
				return emitValue(value.makeStaticRefOperand(), hintResultValue);
			}
			
			llvm::Value* emitNoStaticRef(const SEM::Value& value, llvm::Value* const hintResultValue) {
			...
			llvm::Value* emitMemberAccess(const SEM::Value& value) {
			...
			llvm::Value* emitBindReference(const SEM::Value& value) {
			...
			llvm::Value* emitTypeRef(const SEM::Value& value) {
			...
			llvm::Value* emitCall(const SEM::Value& value, llvm::Value* const hintResultValue) {
			...
			llvm::Value* emitFunctionRef(const SEM::Value& value) {
			...
			llvm::Value* emitMethodObject(const SEM::Value& value) {
				const auto callInfo = genFunctionCallInfo(irEmitter_.function(),
				                                          value);
			...
			llvm::Value* emitInterfaceMethodObject(const SEM::Value& value) {
			...
			llvm::Value* emitStaticInterfaceMethodObject(const SEM::Value& value) {
			...
			llvm::Value* emitTemplateVarRef(const SEM::Value& value,
			                                llvm::Value* const hintResultValue) {
			...
			llvm::Value* emitArrayLiteral(const SEM::Value& value, llvm::Value* const hintResultValue) {
