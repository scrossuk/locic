	...
	namespace SEM {
		...
		class Function final: public TemplatedObject {
			public:
				...
				AST::Node<AST::FunctionDecl>& astFunction();
				const AST::Node<AST::FunctionDecl>& astFunction() const;
				 ...
				 */
				void setAutoGenerated(bool pAutoGenerated);
			...
			private:
				...
				AST::Node<AST::FunctionDecl> fakeASTFunction_;
				AST::Node<AST::FunctionDecl>* function_;
				bool isAutoGenerated_, isPrimitive_;
