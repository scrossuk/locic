#ifndef LOCIC_CODEGEN_PRIMITIVES_FUNCTIONPTRPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_FUNCTIONPTRPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class FunctionPtrPrimitive: public Primitive {
		public:
			FunctionPtrPrimitive(const SEM::TypeInstance& typeInstance);
