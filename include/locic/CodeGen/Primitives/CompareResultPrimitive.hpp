#ifndef LOCIC_CODEGEN_PRIMITIVES_COMPARERESULTPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_COMPARERESULTPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class CompareResultPrimitive: public Primitive {
		public:
			CompareResultPrimitive(const SEM::TypeInstance& typeInstance);
