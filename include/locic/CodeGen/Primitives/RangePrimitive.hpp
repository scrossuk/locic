#ifndef LOCIC_CODEGEN_PRIMITIVES_RANGEPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_RANGEPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class RangePrimitive: public Primitive {
		public:
			RangePrimitive(const SEM::TypeInstance& typeInstance);
