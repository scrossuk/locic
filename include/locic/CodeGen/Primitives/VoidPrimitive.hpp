#ifndef LOCIC_CODEGEN_PRIMITIVES_VOIDPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_VOIDPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class VoidPrimitive: public Primitive {
		public:
			VoidPrimitive(const SEM::TypeInstance& typeInstance);
