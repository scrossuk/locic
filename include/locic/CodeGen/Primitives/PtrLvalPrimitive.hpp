#ifndef LOCIC_CODEGEN_PRIMITIVES_PTRLVALPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_PTRLVALPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class PtrLvalPrimitive: public Primitive {
		public:
			PtrLvalPrimitive(const SEM::TypeInstance& typeInstance);
