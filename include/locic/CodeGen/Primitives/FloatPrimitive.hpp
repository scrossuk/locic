#ifndef LOCIC_CODEGEN_PRIMITIVES_FLOATPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_FLOATPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class FloatPrimitive: public Primitive {
		public:
			FloatPrimitive(const AST::TypeInstance& typeInstance);
