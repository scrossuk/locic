#ifndef LOCIC_CODEGEN_PRIMITIVES_VALUELVALPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_VALUELVALPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class ValueLvalPrimitive: public Primitive {
		public:
			ValueLvalPrimitive(const SEM::TypeInstance& typeInstance);
