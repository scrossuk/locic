#ifndef LOCIC_CODEGEN_PRIMITIVES_PTRPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_PTRPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class PtrPrimitive: public Primitive {
		public:
			PtrPrimitive(const AST::TypeInstance& typeInstance);
