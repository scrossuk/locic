#ifndef LOCIC_CODEGEN_PRIMITIVES_STATICARRAYPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_STATICARRAYPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class StaticArrayPrimitive: public Primitive {
		public:
			StaticArrayPrimitive(const SEM::TypeInstance& typeInstance);
