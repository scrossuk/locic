#ifndef LOCIC_CODEGEN_PRIMITIVES_SIGNEDINTEGERPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_SIGNEDINTEGERPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class SignedIntegerPrimitive: public Primitive {
		public:
			SignedIntegerPrimitive(const AST::TypeInstance& typeInstance);
