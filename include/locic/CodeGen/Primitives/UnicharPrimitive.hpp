#ifndef LOCIC_CODEGEN_PRIMITIVES_UNICHARPRIMITIVE_HPP
#define LOCIC_CODEGEN_PRIMITIVES_UNICHARPRIMITIVE_HPP
...
namespace locic {
	...
	namespace CodeGen {
		...
		class UnicharPrimitive: public Primitive {
		public:
			UnicharPrimitive(const AST::TypeInstance& typeInstance);
