...
namespace locic {
	...
	namespace CodeGen {
		...
		public:
			 ...
			 * \param resultPtr Pointer where result must be constructed
			 *                  if type is NOT passed by value.
			 * \return The generated LLVM value.
			 */
			virtual llvm::Value* generateValue(Function& function, llvm::Value* resultPtr) const = 0;
		...
		public:
			...
			llvm::Value* generateValue(Function& function, llvm::Value* resultPtr) const;
		...
		public:
			...
			llvm::Value* resolve(Function& function, llvm::Value* resultPtr = nullptr);
			
			llvm::Value* resolveWithoutBind(Function& function);
			
		private:
			const PendingResultBase* base_;
			llvm::Value* cacheLastResultPtr_;
