...
namespace locic {
	...
	namespace CodeGen {
		...
		llvm::Constant* genCatchInfo(Module& module, const AST::TypeInstance* catchTypeInstance);
		
		llvm::Constant* genThrowInfo(Module& module, const AST::TypeInstance* throwTypeInstance);
